...
import { createMockToken, FAKE_USER } from "../utils/User"
                ...
                <form onSubmit={handleSubmit(onSubmit)} noValidate className="space-y-5">
                    <div>
                        ...
                        <input
                            ...
                            className={`mt-1 w-full rounded-lg border px-3 py-2 text-sm outline-none transition focus:ring-2 focus:ring-indigo-500 ${errors.username
